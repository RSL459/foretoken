...
| Scorer | `kv_least_loaded`, `least_loaded`, `uniform`, `prefix` | `kv_least_loaded` | Ranks retained targets |
...
Set `scorer` to `prefix` to prefer greater reusable KV-prefix overlap.
