...
- `queue_depth`: Prefers the executable pipeline with the fewest requests waiting in the vLLM scheduler. If any candidate lacks this gauge, the complete round falls back to `least_loaded`.
