...
- `prefix`: Pure KV cache locality policy. Compares matched prefix length, storage tier, and physical locality in that order, and deliberately ignores route-target load.
